...
class RestFrameworkTest(ApiTestCase):
    ...
    def setUp(self):
        ...
        self.entry_list_uri = reverse('entry-list')
        self.entry_detail_uri = reverse('entry-detail', args=(self.entry1.id, ))
        self.user_detail_uri = reverse('user-detail', args=(self.user1.id, ))
